...
function TabbedProductShelf({
  ...
  return (
    <div class="w-full" style={{ background: backGround.backGroundShelf }}>
      <div
        class="w-full container py-3 flex flex-col gap-4 lg:gap-6 lg:py-5 bg-transparent"
      ...
      >
        ...
        <div class="flex justify-start px-4">
          <div class="tabs gap-5">
            {tabs.map((tab, index) => (
              <button
                class={`tab tab-lg gap-2 p-0  uppercase text-base ${
                  index === 0 ? "pl-0" : ""
                } ${index === ti ? "tab-active bg-transparent underline" : ""}`}
                style={{ color: text.backGroundShelf }}
        ...
        <div
          class={`container flex flex-row justify-start lg:justify-end  py-5 cursor-pointer px-5 `}
        >
