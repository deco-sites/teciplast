...
function ColorSelector({ product }: Props) {
  ...
  if (Object.keys(possibilities).includes("Cor Principal")) {
    return (
      <div class="border border-[#cecece] py-2 px-4 sm:max-w-[650px] ">
        <div class="mb-1">
        ...
        <div>
          <ul class="flex gap-2  justify-between py-2 overflow-x-scroll sm:overflow-x-hidden">
            {Object.entries(possibilities["Cor Principal"]).map(
              ([value, link]) => {
                ...
                if (value == "Animal Print") {
                  return (
                    <li>
                      <a href={link}>
                        <img
                          class={` h-8 w-8 rounded-full  border-2 border-white shadow-md shadow-[#737373]`}
                          src={animal}
                        >
                        </img>
                      </a>
                    ...
                    <li>
                      <a href={link}>
                        <div
                          class={`h-8 w-8 ${
                            CORES[value]
                          } rounded-full p-[2px] border-2 border-white shadow-md shadow-[#737373]`}
                        >
                        </div>
                      </a>
                    </li>
