...
function ProductCard(
  ...
  return (
    <div
      id={id}
      class={`group flex flex-col justify-between  w-full lg:min-w-[240px]  h-full  lg:min-h-[400px] max-h-[400px] bg-white border-b-[#002A70] border-b-4 rounded-none text-[#303030] ${
